      ...
      <div className="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        <div className="flex items-center">
          ...
          <Link to="/" className="ml-1 flex items-center">
            ...
            <span className="ml-2 text-xl font-semibold text-neutral-900 font-['Playfair_Display']">
              AADF <span className="text-secondary-600">Procurement</span>
            </span> */}
          </Link>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            <button className="p-2 text-neutral-600 hover:text-neutral-900 focus:outline-none">
          ...
          <div className="relative group">
            ...
            <div className="absolute right-0 pt-2 w-48 bg-white rounded-md shadow-lg py-1 z-20 hidden group-hover:block">
              <Link 
                to="/settings" 
