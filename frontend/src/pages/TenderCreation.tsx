  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold heading-underline mb-2">Create New Tender</h1>
          <p className="text-neutral-600">Create a new tender to start the procurement process</p>
        </div>
      </div>
      <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-5 mb-8">
        <div className="mb-8">
          <div className="flex justify-center">           
            <ol className="flex items-center w-full max-w-2xl p-3 space-x-2 text-sm font-medium text-center text-neutral-500 bg-white rounded-lg sm:text-base sm:p-4 sm:space-x-4 rtl:space-x-reverse">
              <li className={`flex items-center ${currentStep >= 1 ? 'text-primary-600' : 'text-neutral-500'}`}>
                <span className={`flex items-center justify-center w-5 h-5 me-2 text-xs border rounded-full shrink-0 ${currentStep === 1 ? 'border-primary-600 bg-primary-50' : 'border-neutral-300'}`}>
                  1
                </span>
              ...
              <li className={`flex items-center ${currentStep >= 2 ? 'text-primary-600' : 'text-neutral-500'}`}>
                <span className={`flex items-center justify-center w-5 h-5 me-2 text-xs border rounded-full shrink-0 ${currentStep === 2 ? 'border-primary-600 bg-primary-50' : 'border-neutral-300'}`}>
                  2
                </span>
              ...
              <li className={`flex items-center ${currentStep >= 3 ? 'text-primary-600' : 'text-neutral-500'}`}>
                <span className={`flex items-center justify-center w-5 h-5 me-2 text-xs border rounded-full shrink-0 ${currentStep === 3 ? 'border-primary-600 bg-primary-50' : 'border-neutral-300'}`}>
                  3
                </span>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 text-base border border-neutral-300 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors"
                    required
                  />
                </div>
                <div>
